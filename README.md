...
The 'vancouver_transit' project was generated by using the default-python template.

* `src/`: Python source code for this project.
  * `src/vancouver_transit/`: Shared Python code that can be used by jobs and pipelines.
